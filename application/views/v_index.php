    <section>
        <h1><?= $judul ?></h1>
        <p align='justify'>pada pengertian code igneter di atas tadi di jelaskan bahwa codeigneter menggunakan metode MVC. apa itu MVC?
            kita juga harus mengetahui apa itu MVC sebelum masuk dan lebih jauh dalam belajar codeigneter.
        </p>
        <ol>
            <li>model</li>
